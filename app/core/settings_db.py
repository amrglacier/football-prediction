...
# Default leagues and their active status (FULL: all supported by football-data.org free tier)
...
DEFAULT_LEAGUES_CONFIG = {
    ...
    "欧冠资格赛": True, "欧协联资格赛": True,
    # 各国顶级联赛
    "葡超": True, "荷甲": True, "英冠": True,
    "巴西甲": True, "巴西乙": True,
    "俄超": True, "苏超": True, "挪超": True, "瑞超": True, "芬超": True,
    "希腊超": True, "瑞士超": True, "土超": True, "丹超": True, "比利时甲": True,
    "法乙": True, "德乙": True, "意乙": True, "西乙": True, "德丙": True,
    "奥超": True, "英甲": True, "英乙": True, "英非联": True, "北爱超": True, "威超": True,
    "智利甲": True, "秘鲁甲": True, "哥伦比亚甲": True, "阿根廷甲": True, "乌拉圭甲": True,
    "乌克兰超": True, "美职联": True, "日职联": True, "澳超": True, "墨超": True, "中超": True,
    "匈牙利甲": True, "罗马尼亚甲": True, "斯洛文尼亚甲": True,
    # 各国国内杯赛
